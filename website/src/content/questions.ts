...
/**
 * `meta` is WRITTEN, not derived.
 *
 * These descriptions used to be `q.intro.slice(0, 155)` — a blind character
 * count. Three of the four intros are longer than that, so what search results
 * showed was a sentence chopped mid-thought: "...it's almost never because
 * anyone is". A meta description is the ad copy for the page; it has to be a
 * whole sentence that ends where it means to.
 *
 * Keep each under 160 characters. There is a test for it in the build check
 * below the array.
 */
export type QuestionPage = {
  slug: string; title: string; h1: string; intro: string; meta: string;
...
export const questionPages: QuestionPage[] = [
  {
    ...
    meta: "School ends at three, practice starts at 5:30. A registered dietitian on what to eat in that gap, and the small top-up half an hour out.",
    h1: "What should she eat before a 5:30 practice?",
    intro: "School lets out at three. Training starts at 5:30. That gap in the middle is the one most families get wrong, and it's almost never because anyone is feeding their kid badly. The timing is just working against you.",
    sections: [
    ...
    closing: "AthFuelPath puts these times around your athlete's real session, so nobody is doing the math at 3 PM.",
  },
  {
    slug: "after-the-game",
    title: "Did he eat enough after the game?",
    meta: "Your player says they aren't hungry after the game. Why that happens, the hour that actually matters, and what travels well in the car.",
    ...
    sections: [
      ...
      { h: "Easy things that travel", p: "Keep the car stocked and the decision makes itself.", list: ["Chocolate milk or a fruit smoothie", "A sandwich you made before you left", "Fruit, pretzels or a yogurt pouch"] },
  ...
  },
  {
    ...
    meta: "Two or three games, a cooler, and a hotel room with no kitchen. What to pack for a soccer tournament weekend, and how to plan the day.",
  ...
  },
  {
    ...
    meta: "The gap between two games is the hardest call of the day. What to eat so the second game doesn't drag, and what leaves them feeling heavy.",
    h1: "What should she eat between two games?",
    intro: "The gap between games is the hardest call of the day. Too little and the second game drags. Too much, or the wrong thing, and they feel heavy.",
    sections: [
      ...
      { h: "Hot days", p: "When it's hot, fluids matter as much as food, and appetite drops even further. Cold, wet things often go down when nothing else will. Fruit, yogurt, or a smoothie." },
    ],
